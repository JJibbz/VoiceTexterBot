...
namespace VoiceTexterBot
{
    class Bot : BackgroundService
    {
        ...
        public Bot(ITelegramBotClient telegramClient, InlineKeyboardController inlineKeyvoardController, TextMessageController textMessageController, VoiceMessageController voiceMessageController, DefaultMessageController defaultMessageController)
        {
            _telegramClient = telegramClient;
            _inlineKeyboardController = inlineKeyvoardController;
